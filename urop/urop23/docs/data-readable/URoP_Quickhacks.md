...
## 2. Grundidee [ARBEITSSTAND]
Quickhacks sind **digitale Eingriffe** auf vernetzte Ziele, Systeme und Umgebungslogik.
...
## 3. Quickhack-Quellen [ARBEITSSTAND]
### 3.1 OS-Hacks
...
Nicht jede Zielart ist gleich leicht hackbar.
...
## 5. Zugangsarten [GELOCKT / ARBEITSSTAND]
Quickhacks brauchen meist einen **plausiblen Zugangspfad**.

Das ist eine Leitplanke, keine starre Verbotsmauer.
...
Stark, aber orts- und situationsgebunden.

---

## 6. Hackklassen [ARBEITSSTAND]
### 6.1 Info
Der Hack liest, identifiziert oder markiert.
...
## 8. Risiko statt Mana [GELOCKT / ARBEITSSTAND]
...
## 9. Teamplay-Hinweis [GELOCKT]
Quickhacks sollen **Teamplay belohnen**.

Sehr wichtig:
- Elektronik kann erst einen Hackpunkt schaffen
...
**eine gemeinsame Logik statt vier unverbundene Minispiele.**
