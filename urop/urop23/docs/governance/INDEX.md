...
- data/URoP_Items.json
- data/URoP_Waffen.json
- data/URoP_Schutz_und_Ruestung.json
- data/URoP_Cyberware.json
- data/URoP_Quickhacks.json
- data/URoP_Vehicles.json

## Lesefassungen
- docs/data-readable/URoP_Fertigkeiten.md
- docs/data-readable/URoP_Vor_und_Nachteile.md
- docs/data-readable/URoP_Manoever.md
- docs/data-readable/URoP_Items.md
- docs/data-readable/URoP_Waffen.md
- docs/data-readable/URoP_Schutz_und_Ruestung.md
- docs/data-readable/URoP_Quickhacks.md
