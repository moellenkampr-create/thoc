...
Kernleitattribute werden aus den zugeordneten Attributen abgeleitet. Fuer Entwicklung, Anpassung und Feintuning werden Attribute veraendert; die Leitattribute folgen daraus automatisch. Direkte Leitattributsproben sind moeglich, aber selten; im Regelfall wirken Leitattribut und Fertigkeit zusammen.

Aktueller Arbeitsbereich: **0â€“6**, Durchschnittsreferenz: **2**.

### 1.2 Attribute unter Leitattributen

Jedes Leitattribut gliedert sich in vier Attribute. Attribute sind die aktiv veraenderbaren Werte im Charakterbau und im Spiel. Leitattribute werden aus ihnen berechnet und dienen als abgeleitete Sammelwerte fuer Regelabwicklung, Voraussetzungen und Widerstaende.
...
1. **Zuerst den plausiblen Standard setzen:** Was passiert bei 9-12 ohne besondere Zuspitzung?
...
1. **Kampf, enge Bandbreite:** Ziel laeuft schnell, aber ohne Deckung. Standard bleibt Treffer mit Basiswirkung; unten faellt es nur auf Druck, oben steigt es bis schwere Konsequenz.
2. **Kampf, breite Bandbreite:** Schuetze hat Pistolen-Spezialisierung, ruhige Position und klares Zielbild. Schlechte Ergebnisse bleiben oft noch brauchbar; gute Ergebnisse kippen frueher in hohe Wirkung.
3. **Aktion, breite Bandbreite nach unten:** Figur ohne passende Fertigkeit versucht unter Zeitdruck ein Schloss aufzubrechen. Standard ist unsicher; schwache Ergebnisse erzeugen schnell Haken oder Folgeprobleme.
...
### 1.6 Einsatzlogik fÃ¼r besondere FÃ¤higkeiten
...
| Klasse | Bedeutung |
|--------|-----------|
| Frei | sofort, kein Aktionsentzug |
...
| Stufe | Anzahl (Menschen) |
|-------|-------------------|
| Leichte Konsequenzen | 3 |
...
- **Konsequenzen:** anhaltend, stufenbasiert (kurzfristig / leicht / schwer / kritisch), Ã¼ber Versorgung, Reparatur oder Downtime abhandelbar.

Konsequenzen werden je nach Art in passende Bereiche eingeordnet (z. B. Kampf, Quickhack, Ausruestung, Cyberware, Fahrzeuge, Umwelt, Soziales, Mentales). Die vollstÃ¤ndige Abhandlungsliste steht in `data/URoP_Konsequenzen.json`.

### 1.8 Kampfsimulation im Ãœberblick
...
### 1.10 GrÃ¶ÃŸenstufen, Zielwahl und Kampfwirkung
...
### 2.3 Startbudget und Attributwerte
...
Lineare Basiskosten pro Stufe:
- Sammelfertigkeit: 60 EP
- Standardfertigkeit: 20 EP
- Spezialisierung: 15 EP

Anwendungsklassen auf Basiskosten:
- Kampffertigkeit: x 1,25
- Aktionsfertigkeit: x 1,00
- Flufffertigkeit: x 0,50

Aktiver Regelstand fuer Lernkosten:
- keine Fokus-Multiplikatoren
- keine Ueberhang-Aufschlaege
...
URoP kennt bis zu vier Ebenen: Leitattribut â†’ Sammelfertigkeit â†’ Standardfertigkeit â†’ Spezialisierung. Standardfertigkeiten sind der Kern der spielaktiven Fertigkeitsfuehrung. Spezialisierungen duerfen zusaetzlich direkt an eine Sammelfertigkeit angeschlossen werden. Mehrfachzuordnung ist erlaubt, wenn mehrere klare Kompetenzraeume sinnvoll sind.

### 3.1.1 Verbindliche Einteilungen
...
| Business | PrÃ¤senz | Verwaltung, Verhandlung, Oekonomie, Finanzen und rechtlich-organisatorische Praxis |
| Kunst | PrÃ¤senz | kreative Darstellung, Gestaltung, Performance und kuenstlerische Wirkung |

### 3.3 Standardfertigkeiten und Spezialisierungsbeispiele (Auswahl)

| Standardfertigkeit | Andockt an |
|-------------------|------------|
| Waffenlos | Nahkampf |
| Klingenwaffen | Nahkampf |
| Schlagwaffen | Nahkampf |
| Kurzwaffen | Fernkampf |
...
| Kampfschule | moderate | Formale oder halbformale Ausbildung in einem klaren Kampfstil. |

### 3.5 Nachteile (Auswahl)
...
### 4.1 Kampfsimulation (Initiative, Aktionen, Reaktionen)
...
**Sandevistan-/Beschleuniger-Regel:**
...
**Kampf-Scherenbremse durch KÃ¶rperwiderstand:**
...
Fuehrende Datenquelle: `data/URoP_Waffen.json`.

Leitlinie fuer die Waffenerstellung:
- Kurzer Regeltext = kompakte Uebersicht fuer den schnellen Listenblick.
- Voraussetzungen = Mindestanforderungen, Handhabung und harte Bedingungen.
- Langbeschreibung = Einsatzrolle, Wirkung, Munition/Versorgung, Rueckstoss, Feuerfrequenz, Spezialeffekte und Sonderregeln.
...
|------|-----------|-------|---------|------------|
| Kampfmesser | kleinwaffe | melee | 3 | 40 |
| Teleskopschlagstock | kleinwaffe | melee | 2 | 60 |
| Feldmachete | nahkampfwaffe | melee | 3 | 80 |
| Langschwert | zweihandwaffe | melee | 4 | 300 |
| Kriegshammer | zweihandwaffe | melee | 4 | 250 |
| Taserpistole | handfeuerwaffe | ranged | 2 | 200 |
| 9mm Dienstpistole | handfeuerwaffe | ranged | 4 | 500 |
| Kompakte Maschinenpistole | handfeuerwaffe | ranged | 4 | 800 |

Zugangsbeschraenkungen, Legalitaetsstufen und Umgebungseigenschaften (laut, verdeckbar usw.) werden in der Langbeschreibung gefuehrt.

### 5.3 Schutz und RÃ¼stung (Referenzauswahl)

Fuehrende Datenquelle: `data/URoP_Schutz_und_Ruestung.json`. Abdeckungsbereich und Materialeigenschaften stehen in der Langbeschreibung.

Leitlinie:
- Der Schutzwert bleibt der allgemeine Basis-Schutzwert.
- Spezifische Schutzwerte pro Schadensart koennen den Basis-Schutzwert in genau dieser Schadensart ueberschreiben.
- Voraussetzungen beschreiben Handhabungs- und Tragebedingungen als Freitext.
...
| Leselage | Leitidee |
|----------|---------|
| Transit | normale Bewegung, regelarm |
| Druckfahrt | heikle Fahrt unter Gefahr oder Zeitdruck |
| Verfolgung | Position, Linie, Sicht, Hindernisse wichtiger als exakte Meter |
| Fahrzeugkampf | Bordwaffen, Drive-bys, Rammen, Boarding, Aussteigen unter Druck |
